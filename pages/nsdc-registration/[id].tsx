...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('nsdc-registration-in-', '');
    ...
    return (
        <div className='services-pages nsdc-registration'>
            ...
            <div className='heading-line'></div>
            <WhatDo cityName={cityName} />
            <h2 className='main-heading'>NSDC Courses Available in {cityName}</h2>
            <div className='heading-line'></div>
            <CoursesAvailable cityName={cityName} />
            <h2 className='main-heading'>How to Get an NSDC Affiliation?</h2>
            <div className='heading-line'></div>
            <HowGet cityName={cityName} />
            <h2 className='main-heading'>Non-Funded Affiliation</h2>
            <div className='heading-line'></div>
            <NonFunded cityName={cityName} />
            <h2 className='main-heading'>NSDC’s Schemes and Initiatives</h2>
            <div className='heading-line'></div>
            <Schemes cityName={cityName} />
            <h2 className="main-heading">Why RegisterKaro?</h2>
            <div className='heading-line'></div>
            <WhyRegisterkaro />
            <div className='mb-4'></div>
            <RegistrationLinks formattedQuery={'National Skill Development Corporation (NSDC) Registration'} state={state} Query={'nsdc-registration'} city={city} />
        </div>
    )
}
export default Home