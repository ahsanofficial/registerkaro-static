...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('producer-company-registration-in-', '');
    ...
    return (
        <div className='services-pages producer-reg'>
            ...
            <h1 className='main-heading'>Online Producer Company Registration in { cityName }</h1>
            <div className='heading-line'></div>
            <Process cityName={cityName} />
            <h1 className="main-heading">What is a Farmer Producer Company?</h1>
            <div className='heading-line'></div>
            <WhatFarmerProducer cityName={cityName} />
            <h1 className="main-heading">Activities Performed by a Producer Company in { cityName }</h1>
            <div className='heading-line'></div>
            <ActivityPerform cityName={cityName} />
            <h1 className="main-heading">Different Types of Producer Companies in { cityName }</h1>
            <div className='heading-line'></div>
            <DifferentTypes cityName={cityName} />
            <h1 className="main-heading">Advantages of Producer Company Registration in { cityName }</h1>
            <div className='heading-line'></div>
            ...
            <div className='heading-line'></div>
            <LoanAndInvestment cityName={cityName} />
