...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('trademark-search-in-', '');
    ...
    return (
        <div className='services-pages trademark-search-reg'>
            ...
            <div className='heading-line'></div>
            <ApplicableRules cityName={cityName} />
            <h2 className='main-heading'>A description of products/services Involved</h2>
            <div className='heading-line'></div>
            <ServicesInvolved cityName={cityName} />
            <h2 className='main-heading'>Why is it necessary to do a Trademark Search in {cityName}?</h2>
            <div className='heading-line'></div>
            <WhyNecessary cityName={cityName} />
            <h2 className='main-heading'>Important Points to know for Conducting a Trademark Search Availability in {cityName}</h2>
            <div className='heading-line'></div>
            <ImportantPoints cityName={cityName} />
            <h2 className='main-heading'>What is the process to conduct a Trademark IP {cityName} Public Search?</h2>
            <div className='heading-line'></div>
            <WhatProcess cityName={cityName} />
