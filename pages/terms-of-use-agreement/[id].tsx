...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('terms-of-use-agreement-in-', '');
    ...
    return (
        <div className='services-pages terms-of-use-agreement'>
            ...
            <RegistrationLinks formattedQuery={'Terms of Use Agreement'} state={state} Query={'terms-of-use-agreement'} city={city} />
        </div>
    )
}
export default Home
