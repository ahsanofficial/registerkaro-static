...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('nbfc-compliances-in-', '');
    ...
    return (
        <div className='services-pages nbfc-compliances'>
            ...
            <div className='heading-line'></div>
            <EssentialRequirements cityName={cityName} />
