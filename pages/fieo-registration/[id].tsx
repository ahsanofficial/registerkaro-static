...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('fieo-registration-in-', '');
    ...
    return ( 
        <div className='services-pages dubai-reg'>
            ...
            <RegistrationLinks formattedQuery={'FIEO Registration'} state={state} Query={'fieo-registration'} city={city} />
        </div>
    )
}
export default Home