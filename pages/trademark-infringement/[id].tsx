...
let state = [
  ...
  const Home = () => {
    ...
    const cityFromQuery = query?.replace('trademark-infringement-in-', '');
    ...
    return (
        <div className='services-pages dubai-reg'>
            ...
            <h2 className='main-heading'>Types of Trademark Infringement in {cityName}</h2>
            <div className='heading-line'></div>
            ...
            <div className='heading-line'></div>
            <Remedies cityName={cityName} />
            <h2 className='main-heading'>What is Passing Off ?</h2>
            <div className='heading-line'></div>
            <Passingoff cityName={cityName} />
