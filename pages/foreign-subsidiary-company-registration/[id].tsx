...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('foreign-subsidiary-company-registration-in-', '');
    ...
    return (
        <div className='services-pages foreign-subsidiary-company-registration'>
            ...
            <h2 className='main-heading'>Benefits of Registering a Foreign Subsidiary in {cityName}</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName} />
            <h2 className='main-heading'>Examples of Some Foreign Subsidiary Companies in {cityName}</h2>
            <div className='heading-line'></div>
            <Examples cityName={cityName} />
            <h2 className='main-heading'>Difference between Foreign Branch and Subsidiary</h2>
            <div className='heading-line'></div>
            <Difference cityName={cityName} />
            ...
            <div className='heading-line'></div>
            <ComplianceReq cityName={cityName} />
            <h2 className='main-heading'>Applicable Taxes on Foreign Subsidiary in {cityName}</h2>
            <div className='heading-line'></div>
            <ApplicableTaxes cityName={cityName} />
            <h2 className='main-heading'>Costs included in Registering a Subsidiary in {cityName}</h2>
            <div className='heading-line'></div>
            <CostsInclude cityName={cityName} />
