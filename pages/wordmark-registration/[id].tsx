...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('wordmark-registration-in-', '');
    ...
    return (
        <div className='services-pages wordmark-registration-reg'>
            ...
            <h2 className='main-heading'>What is the Eligibility for the Registration of Wordmark Online in {cityName}?</h2>
            <div className='heading-line'></div>
            <Wordmark  cityName={cityName} />
            <h2 className='main-heading'>A description of products/services Involved</h2>
            <div className='heading-line'></div>
            <Products  cityName={cityName} />
            ...
            <h2 className='main-heading'>Wordmark Registration Process in {cityName}</h2>
            <div className='heading-line'></div>
            <Registration  cityName={cityName} />
            <h2 className='main-heading'>Validity of Wordmark Registration</h2>
            <div className='heading-line'></div>
            <Validity  cityName={cityName} />
