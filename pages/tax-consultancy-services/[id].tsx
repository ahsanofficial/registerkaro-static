...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('tax-consultancy-services-in-', '');
    ...
    return (
        <div className='services-pages qatar-reg'>
            ...
            <h2 className='main-heading'>Benefits for Start-ups in {cityName}</h2>
            <div className='heading-line'></div>
            ...
            <div className='heading-line'></div>
            <ProfessionalTax  cityName={cityName} />
            ...
            <div className='heading-line'></div>
            <EligibilityProfessional  cityName={cityName} />
            <h2 className='main-heading'>TDS Return Filing</h2>
            <div className='heading-line'></div>
            <TDS  cityName={cityName} />
            <h2 className='main-heading'>Benefits of TDS Return Filling</h2>
            <div className='heading-line'></div>
            <BenefitsTds cityName={cityName} />
            <h2 className='main-heading'>Eligibility Criteria for TDS Deduction in {cityName}</h2>
            <div className='heading-line'></div>
            <CriteriaTds cityName={cityName} />

            <h2 className='main-heading'>Income Tax Return Filing</h2>
            <div className='heading-line'></div>

            <IncomeTaxReturn  cityName={cityName} />
            <h2 className='main-heading'>Benefits of ITR Filing</h2>
            <div className='heading-line'></div>
            <BenefitsITR  cityName={cityName} />
            <h2 className='main-heading'>Eligibility for Filing Income Tax Returns in {cityName}</h2>
            <div className='heading-line'></div>
            < EligibilityFiling  cityName={cityName} />
