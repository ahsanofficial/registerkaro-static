...
const Home = () => {
    return (
        <div className='services-pages gsp-registration'>
            ...
            <div className='heading-line'></div>
            <DifferenceGSPnUsual cityName={'India'} />
