...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('patent-registration-in-', '');
    ...
    return (
        <div className='services-pages patent-registration'>
            <Head>
                <title>Patent registration online in {cityName}</title>
            ...
            <div className='heading-line'></div>
            <TypesPatents  cityName={cityName}/>
            <h2 className='main-heading'>Why Patent Registration? </h2>
            <div className='heading-line'></div>
            <WhyPatent  cityName={cityName}/>
