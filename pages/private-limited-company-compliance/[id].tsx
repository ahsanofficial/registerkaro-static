...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('private-limited-company-compliance-in-', '');
    ...
    return (
        <div className='services-pages private-limited-company-compliance-reg '>
            ...
            <h2 className='main-heading'>What are the Benefits of Private Limited Company Compliance in {cityName}?</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName}/>
             <h2 className='main-heading'>Types of Compliance for a Company Registered in {cityName}</h2>
            <div className='heading-line'></div>
            <TypeOfComp cityName={cityName}/>
            ...
            <h2 className='main-heading'>Other Annual Compliance for Private Limited Company in {cityName}</h2>
            <div className='heading-line'></div>
