...
const Home = () => {
  ...
  return (
    <div className="services-pages iec-registration-reg">
      ...
      <h1 className="main-heading">Benefits of IEC Registration in {cityName}</h1>
      <div className="heading-line"></div>
      <AdvantagesBIS cityName={cityName} />
      <h1 className="main-heading">What is the eligibility to get the Import Export Code in {cityName}?</h1>
      <div className="heading-line"></div>
      <Eligibility cityName={cityName} />
      <h1 className="main-heading">Prerequisites for applying IEC Code in {cityName} </h1>
      <div className="heading-line"></div>
