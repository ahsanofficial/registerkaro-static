    ...
    return (
        <div className='services-pages epr-authorization-for-e-waste'>
           <Head>
            ...
            <div className='heading-line'></div>
            <BenefitsOfState cityName={'India'}/>
            ...
            <RegistrationLinks formattedQuery={'Get Online EPR Authorization for E-Waste'} state={state} Query={'epr-authorization-for-e-waste'} city={city} />
        </div>
    )
}
export default Home