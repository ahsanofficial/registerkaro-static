...
let state = [
  ...
  const Home = () => {
    ...
    const cityFromQuery = query?.replace('tea-board-registration-in-', '');
    ...
    return (
        <div className='services-pages tea-board-registration'>
            ...
            <div className='heading-line'></div>
            <Pricing  cityName={cityName} />
            <h2 className="main-heading">Why RegisterKaro?</h2>
            <div className='heading-line'></div>
            <WhyRegisterkaro />
            <div className='mb-4'></div>
            <RegistrationLinks formattedQuery={'Tea Board Registration'} state={state} Query={'tea-board-registration'} city={city} />
        </div>
    )
}
export default Home
