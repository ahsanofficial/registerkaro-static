...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('trademark-hearing-in-', '');
    ...
    return (
        <div className='services-pages trademark-hearing'>
            ...
            <div className='heading-line'></div>
            <KeyConsiderations cityName={cityName} />
            ...
            <div className='heading-line'></div>
            <RecentDevelopments cityName={cityName} />
