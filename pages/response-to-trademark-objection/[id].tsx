...
function formatString(input: string) {
  ...
  const Home = () => {
    ...
    const cityFromQuery = query?.replace('response-to-trademark-objection-in-', '');
    ...
    return (
        <div className='services-pages'>
            ...
            <div className='heading-line'></div>
            <WhatTrademar cityName={cityName} />
            <h2 className='main-heading'>Reason for Trademark Objection?</h2>
            <div className='heading-line'></div>
            <ReasonTrademark cityName={cityName} />
            ...
            <div className='heading-line'></div>
            <TrademarkObjection cityName={cityName} />
