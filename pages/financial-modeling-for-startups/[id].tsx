...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('financial-modeling-for-startups-in-', '');
    ...
    return (
        <div className='services-pages financial-modeling-for-startups-reg'>
            ...
            <h2 className='main-heading'>Importance of Financial Modeling for Businesses in {cityName}</h2>
            <div className='heading-line'></div>
            ...
            <div className='heading-line'></div>
            <KeyChallanges  cityName={cityName}/>
            <h2 className='main-heading'>Best Practices in Financial Modeling for Businesses in {cityName}</h2>
            <div className='heading-line'></div>
            <BestPractices  cityName={cityName}/>
            <h2 className='main-heading'>Important Points to Make a Financial Model</h2>
            <div className='heading-line'></div>
            <ImportantPoint cityName={cityName}/>
