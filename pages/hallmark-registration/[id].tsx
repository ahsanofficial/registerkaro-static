...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('hallmark-registration-in-', '');
    ...
    return (
        <div className='services-pages hallmark-regi'>
            ...
            <h1 className='main-heading'>Apply for Hallmark Registration Online in {cityName} </h1>
            ...
            <div className='heading-line'></div>
            <ListDifferent cityName={cityName}/>
            <h2 className='main-heading'>New Methods of Hallmarking</h2>
            <div className='heading-line'></div>
            <NewMethods cityName={cityName}/>
            ...
            <h2 className='main-heading'>Procedure for Hallmark Registration in {cityName}</h2>
            <div className='heading-line'></div>
