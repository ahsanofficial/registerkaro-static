...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('closing-private-limited-company-in-', '');
    ...
    return (
        <div className='services-pages closing-private-limited-company'>
            ...
            <RegistrationLinks formattedQuery={'Closing Private Limited Company'} state={state} Query={'closing-private-limited-company'} city={city} />
        </div>
    )
}
export default Home;