...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('gst-registration-in-', '');
    ...
    return (
        <div className='services-pages gst-registration'>
            ...
            <h2 className='main-heading'>What are the Different Types of GST in {cityName}?</h2>
            <div className='heading-line'></div>
            <DifferentTable cityName={cityName}/>
            <h2 className='main-heading'>Benefits of GST Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <Benefits cityName={cityName}/>
            <h2 className='main-heading'>Who can apply for GST Registration in {cityName}?</h2>
            <div className='heading-line'></div>
            <Who cityName={cityName}/>
            <h2 className='main-heading'>List of Vital Documents Required for GST Registration in {cityName}</h2>
            <div className='heading-line'></div>
            <VitalDocuments cityName={cityName}/>
            <h2 className='main-heading'>Online GST Registration Process with RegisterKaro</h2>
            <div className='heading-line'></div>
            <RegistrationProcess cityName={cityName}/>
            <h2 className='main-heading'>GST Return Filing</h2>
            <div className='heading-line'></div>
            <GSTReturn cityName={cityName}/>
            <h2 className='main-heading'>Penalty for Not Getting GST in {cityName}</h2>
            <div className='heading-line'></div>
            <Penalty cityName={cityName}/>
            <h2 className='main-heading'>Voluntary Registration under GST</h2>
            <div className='heading-line'></div>
            <Voluntary cityName={cityName}/>
            <h2 className='main-heading'>Exemption on GST Registration in {cityName}</h2>
            <div className='heading-line'></div>
