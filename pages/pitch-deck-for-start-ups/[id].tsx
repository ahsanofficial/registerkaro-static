...
let state = [
  ...
  const Home = () => {
    ...
    const cityFromQuery = query?.replace('pitch-deck-for-start-ups-in-', '');
    ...
    return (
        <div className='services-pages pitch-deck-for-start-ups'>
            <Head>
            ...
            <RegistrationLinks formattedQuery={'Pitch Deck for Start-ups'} state={state} Query={'pitch-deck-for-start-ups'} city={city} />
        </div>
    )
}
export default Home