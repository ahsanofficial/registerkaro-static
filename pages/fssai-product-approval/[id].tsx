...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('fssai-product-approval-in-', '');
    ...
    return (
        <div className='services-pages fssai-product-approval-reg'>
           <Head>
            ...
            <div className='heading-line'></div>
            <System  cityName={cityName} />
            <h2 className='main-heading'>Which Food products require product approval?</h2>
            <div className='heading-line'></div>
            <Require  cityName={cityName} />
            <h2 className='main-heading'>Earlier Rules and Regulations for FSSAI Product Approval</h2>
            <div className='heading-line'></div>
            <EarlierRules  cityName={cityName} />
            <h2 className='main-heading'>When do you need product approval in {cityName}?</h2>
            <div className='heading-line'></div>
            <Approval  cityName={cityName} />
            ...
            <h2 className='main-heading'>Procedure for getting Product Approval in {cityName}</h2>
            <div className='heading-line'></div>
