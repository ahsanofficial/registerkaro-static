...
const Home = () => {
  ...
  const cityFromQuery = query?.replace('medical-device-registration-in-', '');
  ...
  return (
    <div className="services-pages medical-device-registration-reg">
      ...
      <h1 className="main-heading">Get Online Medical Device Registration in {cityName}</h1>
      <div className="heading-line"></div>
      <Process  cityName={cityName} />
      <h1 className="main-heading">Applicable Rules/Acts/ Regulations</h1>
      <div className="heading-line"></div>
      <ApplicableRegulations  cityName={cityName}/>
      ...
      <div className="heading-line"></div>
      <EligibilyMandatory  cityName={cityName} />
      <h1 className="main-heading">A description of products/services involved</h1>
      <div className="heading-line"></div>
      <DescriptionServices  cityName={cityName} />
      ...
      <div className="heading-line"></div>
      <MandatoryCom  cityName={cityName}/>
