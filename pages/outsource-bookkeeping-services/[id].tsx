...
const Home = () => {
    ...
    const cityFromQuery = query?.replace('outsource-bookkeeping-services-in-', '');
    ...
    return (
        <div className='services-pages outsource-bookkeeping-services'>
            <Head>
                <title>Outsource bookkeeping services in {cityName}</title>
