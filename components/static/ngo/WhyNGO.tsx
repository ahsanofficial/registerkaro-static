  ...
  return (
    <div className="Classification flex w-80 m-auto mobile-flex-column" id="WhyNGO">
      ...
      <div className="flex-7">
        ...
        <p><strong>4: Tax Benefits:</strong> NGOs registered under the Income Tax Act of 2013 in India enjoy various tax benefits, contributing to financial sustainability.</p>
