...
export const Prerequisites = ({ cityName }: HeroProps) => {
  return (
    <div id="Prerequisites">
        <p className="main-para">Liquor License in {cityName} is subject to validity which means that it is required to be renewed after a certain specific time period. Moreover, the License is also subject to revocation. These circumstances for either revocation or renewal can be observed below:</p>
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
           <p><strong>Validity:</strong> In {cityName}, the normal validity time for a liquor license is one year from the date of issuance. During this time, the licensee is able to distribute and sell alcoholic beverages in accordance with the terms of the license.</p>
