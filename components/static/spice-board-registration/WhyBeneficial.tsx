        ...
        <div id="WhyBeneficial">
            ...
            <div className='whyBeneficial flex w-80 m-auto mobile-flex-column'>
                ...
                <div className="flex-7">
                    ...
                    <p>Leads the program aimed at enhancing the quality of Indian spices. Oversees a thorough and current database for companies involved in exporting and importing. Facilitates communication among global organizations, exporters, and government officials via contact group initiatives. Showcases India at prominent global food events; hosts food expos and cooking workshops to create awareness.</p>
                </div>
            </div>
        </div>
    )
