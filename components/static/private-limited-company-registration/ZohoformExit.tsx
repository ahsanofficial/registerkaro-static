...
const ZohoformExit: React.FC<ZohoFormServiceProps> = ({ service }) => {
	const zohoFormCode = `
  ...
  <div class="zf-headerLogo"><h2>Register<span>Karo</span></h2></div>
  ...
  <li class="zf-tempFrmWrapper zf-large"><h3 class='zf-formHeading'>Are you still confused about your company registration ? <br/><span class='highlightedHeadingText'>Take the first step</span> by filling out the form below.</h3>
  ...
  <span> <input fieldType=9  type="email" maxlength="255" name="Email" checktype="c5" value="" placeholder="Email Id" required/></span> <p id="Email_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
  ...
  <span> 
  <input type="text" compname="PhoneNumber" name="PhoneNumber_countrycode" maxlength="10" checktype="c7" value="" phoneFormat="1" isCountryCodeEnabled=true fieldType="11" id="international_PhoneNumber_countrycode" valType="number" phoneFormatType="1" placeholder="Phone Number" value='' required/>
  <label></label> </span>
  ...
  <ul class='ul'><li class="zf-fmFooter"><button class="zf-submitColor" >Get Free Consultation</button></li></ul></div><!-- 'zf-templateWrapper' ends --></form></div>
  ...
  function zf_FocusNext(elem,event) {  
	...
	return (
		<form className="ZohoformExit">
			<div dangerouslySetInnerHTML={{ __html: zohoFormCode }} />
		</form>
	);
};

export default ZohoformExit;
