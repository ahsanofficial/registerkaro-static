...
const Exemption = ({ cityName }: HeroProps) => {
  return (
    <div id="Exemption">
        <p className="main-para">As per Indian Government, the following taxpayers are excluded from GST Registration in {cityName}:</p>
      ...
      <div className="flex-3">
        ...
        <div className="flex-7">
            <p><strong>1. People making exempt supplies: </strong>Registration of GST in {cityName} is not required for those who provide exempt & nil-rated supplies. Unprocessed food, local & overnight train travel, education, healthcare without medications, hotel & lodge stays for less than Rs. 1000 rent, colouring books, and accessories like bindis, bangles & sindoors are among the exempt & NIL rated products & services.</p>
            <p><strong>2. Agriculturists:</strong> People who supply products out from their cultivating land are exempt from GST Registration in {cityName}.</p>
            ...
            <p><strong>6. People with activities not considered as service or supply of goods/products:</strong> In {cityName}, GST Registration is not required for individuals who provide services to any company or organisation, any court or tribunal, property, auctions, funerals, or those who hold political positions.</p>
        </div>
