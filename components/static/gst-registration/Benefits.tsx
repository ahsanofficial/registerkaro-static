...
const Benefits = ({ cityName }: HeroProps) => {
  return (
    <div id="Benefits">
        <p className="main-para">Following are the benefits of GST Registration in {cityName}:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
            <p><strong>1. Small Business Composition Scheme:</strong> Under GST, small businesses (with a turnover of Rs. 20-75 lakhs) can benefit as it gives an option to lower taxes by utilising this Scheme. This move has brought down the tax & compliance burden on many small businesses in {cityName}.</p>
