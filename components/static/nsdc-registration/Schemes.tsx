...
export const Schemes = ({ cityName }: HeroProps) => {
  return (
    <div id="Schemes">
      ...
      <div className="flex w-80 m-auto mobile-flex-column">
        ...
        <div className="flex-6">
          <ol>
            ...
            <li><strong>{cityName} International Skill Centre (IISC) Network: </strong>This platform facilitates international workforce opportunities for Indians. It includes Member Organizations operating through various fixed centres known as IISC.</li>
            ...
            <li><strong>Skill Impact Bond: </strong>This initiative has supported over 50,000 young people in {cityName} for more than 4 years, with 60% being women and girls. They receive training for skills needed in various sectors for COVID-19 recovery.</li>
