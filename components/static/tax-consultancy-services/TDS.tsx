...
export const TDS = ({ cityName }: HeroProps) => {
  return (
    <div id="TDS">
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
       
        <div className="flex-7">
           <p>Tax Deducted at Source (TDS) is a method employed by the Government of {cityName} to gather taxes right at the moment a transaction happens. Under this system, tax is deducted when the receiver's account gets credited or when payment is made, whichever happens first. The company responsible for the payment must submit the deducted tax amount to the Income Tax Department. TDS is beneficial as it enables the direct remittance of a portion of the tax to the Income Tax Department.</p>
