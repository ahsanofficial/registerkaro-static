    ...
    <div id="Benefits">
      <div className="flex w-80 m-auto mobile-flex-column">
        ...
        <div className="flex-6 pt-5">
          <ol>
            <li>
                India's high growth potential and the government's proactive approach towards improving the ease of doing business create a fertile ground for foreign companies. Registering a foreign subsidiary in India opens up a spectrum of advantages which are as follows:
                <ol>
                    ...
                    <li><strong>Cost Efficiency: </strong>Establishing manufacturing facilities in India can significantly lower material and operational costs, thanks to the availability of affordable labor and resources.</li>
            ...
            <li>
                Moreover, the regulatory environment in India supports foreign subsidiaries through:
                <ol>
