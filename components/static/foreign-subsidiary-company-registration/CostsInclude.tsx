...
export const CostsInclude = ({ cityName }: HeroProps) => {
  return (
    <div id="CostsInclude">
      <div className="flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-6 pt-5">
          ...
          <p>Are you planning to start a subsidiary company in {cityName} but struggling with the registration process? RegisterKaro can help you expand your business across borders by registering a subsidiary company in {cityName}. Don't be left behind due to the fear of complicated registration procedures. RegisterKaro’s expert team consisting of experienced CA, CS and Advocates will help you effectively register your subsidiary company in {cityName}. Consult with RegisterKaro, who are having years of experience in all types of company incorporation in {cityName} and Abroad. We offer different company registration packages as per your specific requirements.</p>
        </div>
