  ...
  return (
    <div id="WhyChoose">
      <p className="main-para">
        RegisterKaro serves as your ultimate solution for Network Licensing
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column">
        ...
        <div className="flex-7">
          <p>
            ...
            <strong>Network Licensing</strong> Process. Rest assured; our team ensures your
          ...
          <p>
            ...
            <strong>Network Licensing </strong>Process at highly competitive rates, ensuring that
