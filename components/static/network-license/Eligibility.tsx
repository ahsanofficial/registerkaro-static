  ...
  return (
    <div id="Eligibility">
      ...
      <div className="flex-3">
        <Image
            alt="Eligibility Criteria for Network License in {cityName}"
