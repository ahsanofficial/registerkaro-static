...
export const Hero = ({ cityName }: HeroProps) => {
    return (
        <div className="hero align-center mobile-flex-column">
            ...
            <h4 className='mb-4'>Change Your Registered Office Address</h4>
                <p>It is necessary to intimate the ROC regarding to change your registered office address of the Company during Company Incorporation.</p>
