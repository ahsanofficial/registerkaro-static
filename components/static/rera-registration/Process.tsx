import certificate from '../../../assets/images/static/rera-registration/certificate.svg';
...
export const Process = () => {
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center">Online RERA Registration</p>
                <div>
                    <Image alt="An Overview of Online RERA Registration in India" className="certificate h-100 w-100" loading="lazy" src={certificate} />
                </div>
            </div>
        </div>
    )
