      ...
      <div className='flex-5'>
        ...
        <div className='flex-5 text-justify fs-20 p-color-black'>
          <div className={`${active === '1' ? 'active' : 'none'}`}>
            <h3>Step 1:</h3>
            <p className='mb-0'>Down the application form for the registration process form the State’s official RERA Website. Fill in the form with required details for filings such as individual details, etc.
            </p>
          </div>
