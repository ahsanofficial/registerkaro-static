...
import bft from "../../../assets/images/static/trademark-search/Important_Points_to_know.svg";
interface HeroProps {
    cityName: string;
}
const ImportantPoints = ({ cityName }: HeroProps) => {
  return (
    <div id="ImportantPoints">
        <p className="main-para">Following are some vital factors to keep in mind while conducting a Trademark Search Availability in {cityName}:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column">
      <div className="flex-4">
        <Image
            alt="Important Points to know for Conducting a Trademark Search Availability in India"
