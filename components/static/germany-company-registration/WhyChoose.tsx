...
import dft from "../../../assets/images/static/germany-company-registration/Why Choose RegisterKaro_for_Company_Registration_in_the_United_Kingdom.svg"

export const WhyChoose = () => {
  return (
    <div id="WhyChoose">
      <p className="main-para">RegisterKaro has been one stop solution for Thailand Company Registration for the varied ranges of benefits such as:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column">
      <div className="flex-3">
          <Image
            alt="Why Choose RegisterKaro for Company Registration in the Thailand?"
        ...
        <div className="flex-7 pt-3">
           ...
           <p><strong>Cost-effective: </strong>RegisterKaro Thailand Company Registration Related services are of premium quality at the most efficient rate, which suits the client's pocket, making sure that quality service is not the only thing the client gains on our platform.</p>
