    ...
    <div id="WhyChoose">
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">        
        <div className="flex-7">
          <p><strong>Pool of Experts: </strong>RegisterKaro holds a large group of experts from all over the world having specialization in getting Petrol Pump License. Our team of experts make sure that you work is taken care of in the most effective possible manner.</p>
          ...
          <p><strong>Process Alteration: </strong>RegisterKaro builds the trust among its clients and because of only this trust we have built a good network in worldwide marketplace.</p>
