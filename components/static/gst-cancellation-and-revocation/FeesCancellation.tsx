...
import bft from "../../../assets/images/static/gst-cancellation-and-revocation/pre-incorporation.svg";
interface HeroProps {
    cityName: string;
}
const FeesCancellation = ({ cityName }: HeroProps) => {
  return (
    <div id="FeesCancellation">
      <div className="benefits flex w-80 m-auto mobile-flex-column">
      <div className="flex-5">
        <Image
            alt="Fees for Cancellation and Revocation of GST Registration"
