    ...
    <div id="WhyChoose">
      ...
      <div className="flex-3">
        ...
        <div className="flex-7">
          ...
          <p><strong>Trusted partner of 10000+ Clients:</strong> RegisterKaro has earned the trust of more than 10000+ clients who have availed our Cheque Bounce related services.  Their trust in us from a term in continuity is proof of our services backed by quality and assurance</p>
        </div>
