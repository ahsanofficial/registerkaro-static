...
export const WhyChoose = () => {
  return (
    <div id="WhyChoose">
      <p className="main-para">RegisterKaro has been one stop solution for New Zealand Company Registration for the varied ranges of benefits such as:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
           ...
           <p><strong>Cost-effective :</strong>RegisterKaro New Zealand Company Registration Related services are of premium quality at the most efficient rate, which suits the client's pocket, making sure that quality service is not the only thing the client gains on our platform. </p>
        ...
        <div className="flex-3">
          <Image
            alt="Why Choose RegisterKaro for Company Registration in the New Zealand?"
