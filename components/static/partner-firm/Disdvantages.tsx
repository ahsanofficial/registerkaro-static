    ...
    <div className='DocumentButtonWise w-80 m-auto' id='Disdvantages'>
      ...
      <div className='flex-5 text-justify fs-20 p-color-black'>
          ...
          <div className={`${active === '4' ? 'active' : 'none'}`}>
            <h3>Difficult to Raise Funds: </h3>
            <p>
        ...
        <div className='flex-5'>
          <button onClick={() => handleActive('1')} className={`btn flex ${active === '1' ? 'active-btn' : 'none-btn'}`}>
            <div>
              <Image src={one} alt="one" loading="lazy" width={30} height={30} />Unlimited Liability
            </div>
          ...
          <button onClick={() => handleActive('2')} className={`btn flex ${active === '2' ? 'active-btn' : 'none-btn'}`}>
            <div>
              <Image src={two} alt="two" loading="lazy" width={30} height={30} />No Perpetual Successio
            </div>
            <Image src={arrow} alt="arrow" loading="lazy" width={30} height={30} />
          </button>
