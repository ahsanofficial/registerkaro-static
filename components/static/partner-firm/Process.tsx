    ...
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            <div className='flex-5'>
                <p className='text-justify'>One of the most essential types of company organisation is a partnership firm. It is a common company structure in { cityName }. A partnership firm must be formed by at least two people. A partnership firm is formed when two or more people join forces to start a business and divide the profits in an agreed-upon ratio. Any type of trade, occupation, or profession is included in the partnership business. Partnership Firm Registration refers to the registration of the partnership firm with the Registrar of Firms by its partners. The partners must register their firm with the Registrar of Firms in the state in which it is based. Because partnership firm registration is not required, the partners can apply for registration of the partnership firm either when the firm is formed or afterward at any point during its operation.<br/><br/>To register a partnership, two or more people must come together as partners, agree on a firm name, and sign a partnership deed. Partners, on the other hand, cannot be members of a Hindu Undivided Family or husband and wife. <br/><br/>In { cityName }, partnership firms are governed and regulated under the { cityName }n Partnership Act, 1932. Partners are the people who work together to form a partnership firm. A contract between the partners establishes the partnership firm. A partnership deed is a contract between the partners that governs the relationship between the partners as well as the partnership firm</p>
                    ...
                    <ul>
                        <ul>
                            ...
                            <a href="#Benefits" className="scrollTo">
                                <li>Importance of Registering a Partnership Firm in { cityName }</li>
                            </a>
                            ...
                            <a href="#Checklist" className="scrollTo">
                                <li>Checklist for Partnership Firm Registration in { cityName }</li>
                            </a>
                            <a href="#DocumentsForPartnership" className="scrollTo">
                                <li>Documents for Partnership Firm Registration in { cityName }</li>
                            </a>
                            ...
                            <a href="#ProcedureForPartnership" className="scrollTo">
                                <li>Procedure for Partnership Firm Registration in { cityName }</li>
                            </a>
