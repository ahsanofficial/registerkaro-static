    ...
    <div id="WhyChoose">
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column">
        ...
        <div className="flex-6">
          <p><strong>Group of Experts: </strong>RegisterKaro holds a large pool of Experts from all over the world specializing in SSI registration services.  Our team of experts makes sure that your work is taken care of in the most effective manner possible.</p>
