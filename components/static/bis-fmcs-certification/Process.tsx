    ...
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            <div className='flex-5'>
                ...
                <p className='text-justify'>The process involves a thorough factory audit of manufacturing units located outside {cityName}. This audit aims to assess whether the manufacturer meets all necessary requirements to obtain a BIS Certificate for importing products into {cityName} under the Foreign Manufacturer Certification Scheme. This certification is crucial for foreign manufacturers intending to export and sell their products in the Indian market.</p>
