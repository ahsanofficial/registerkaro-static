    ...
    <div id="WhyChoose">
      ...
      <div className="flex-3">
        ...
        <div className="flex-7">
          ...
          <p><strong>Cost-effective: </strong>RegisterKaro Qatar Company Registration Related services are of premium quality at the most efficient rate, which suits the client's pocket, making sure that quality service is not the only thing the client gains on our platform.</p>
