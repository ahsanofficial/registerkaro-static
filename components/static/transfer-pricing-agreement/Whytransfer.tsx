...
import dft from "../../../assets/images/static/transfer-pricing-agreement/Why Transfer Pricing.svg";
interface HeroProps {
    cityName: string;
}
export const Whytransfer = ({ cityName }: HeroProps) => {
  return (
    <div id="Whytransfer">
