import certificate from '../../../assets/images/static/virtual-cfo-services/certificate.svg';
...
export const Process = () => {
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center">Virtual CFO Services </p>
                <div>
                    <Image alt="AVirtual CFO Services Meaning" className="certificate h-100 w-100" loading="lazy" src={certificate} />
                </div>
            </div>
        </div>
    )
