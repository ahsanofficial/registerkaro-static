import certificate from '../../../assets/images/static/pf-return/CERTIFICATE.svg';
...
export const Process = ({ cityName }: HeroProps) => {
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center">Provident Fund</p>
                <div>
                    <Image alt="What is PF?" className="certificate h-100 w-100" loading="lazy" src={certificate} />
                </div>
            </div>
        </div>
    )
