...
import dft from "../../../assets/images/static/u-k-company-registration/Why Choose RegisterKaro_for_Company_Registration_in_the_United_Kingdom.svg"
    ...
    <div id="WhyChoose">
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
           ...
           <p><strong>Cost-effective :</strong> RegisterKaro UK Company Registration Related services are of premium quality at the most efficient rate, which suits the client's pocket, making sure that quality service is not the only thing the client gains on our platform.</p>
