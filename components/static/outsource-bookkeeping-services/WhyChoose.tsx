  ...
  return (
    <div id="WhyChoose">
      <p className="main-para">
        RegisterKaro has been one stop solution for the PF Return related
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        ...
        <div className="flex-7">
          <p>
            ...
            specializing in Outsource Bookkeeping services. Our team of experts
          ...
          <p>
            ...
            RegisterKaro Outsource Bookkeeping services are of premium quality
          ...
          <p>
            ...
            have availed our Outsource Bookkeeping services. Their trust in us
            from a term in continuity is proof of our services backed by quality
            and assurance.
          </p>
        </div>
        <div className="flex-4">
          <Image
            alt="Why Choose RegisterKaro for Company Registration"
