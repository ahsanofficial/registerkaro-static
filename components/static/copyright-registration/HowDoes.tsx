...
const HowDoes = ({ cityName }: HeroProps) => {
  return (
    <div id="HowDoes">
      ...
      <div className="flex-3">
        ...
        <div className="flex-7">
          <p>
            ...
            who specialize in copyright-related services. Our team of experts
          ...
          <p>
            ...
            RegisterKaro Copyright Related Services are of premium quality at
          ...
          <p>
            ...
            have availed themselves of copyright registration services. Their
