...
//   return (
//      <div className='DocumentButtonWise w-80 m-auto' id='StateFSSAILicense'>
...
//             <p className='mb-0 pt-2'>1. Ensure that all partners of the firm consent to the conversion and are willing to become partners in the LLP.
//             <p className='mb-0 pt-2'>1. Verify that the firm meets the eligibility criteria as per the schedule.
//             </p>
//           </div>
//           <div className={`${active === '2' ? 'active' : 'none'}`}>
//             <h3>Step 2 - Document Preparation:</h3>
//             <p className='mb-0 pt-2'>1. Draft a statement to be signed by all partners, containing details such as the firm's name, registration number, and date of registration under the Indian Partnership Act, 1932.
//             <p className='mb-0 pt-2'>1. Prepare the necessary incorporation documents and statements as per the requirements of section 11.
//             </p>
//           </div>
//           <div className={`${active === '3' ? 'active' : 'none'}`}>
//             <h3>Step 3 - Submission to Registrar:</h3>
//             <p className='mb-0 pt-2'>1. File the documents with the Registrar of Companies, along with the prescribed fee.
//             <p className='mb-0 pt-2'>1. Ensure the completeness and accuracy of the provided information.
//             </p>
//           </div>
//           <div className={`${active === '4' ? 'active' : 'none'}`}>
//             <h3>Step 4 - Registrar's Review:</h3>
//             <p className='mb-0 pt-2'>1. The Registrar reviews the submitted documents and verifies their authenticity.
//             <p className='mb-0 pt-2'>1. In case of any deficiencies, the Registrar may request additional information or clarification.
//             </p>
//           </div>
//           <div className={`${active === '5' ? 'active' : 'none'}`}>
//             <h3>Step 5 - Registration:</h3>
//             <p className='mb-0 pt-2'>1. Upon satisfactory review, the Registrar registers the conversion and issues a certificate of registration.
//             <p className='mb-0 pt-2'>1. The LLP is now officially recognized as a separate legal entity under the LLP Act.
//             </p>
//           </div>
//           <div className={`${active === '6' ? 'active' : 'none'}`}>
//             <h3>Step 6 - Notification to Registrar of Firms:</h3>
//             <p className='mb-0 pt-2'>1. Within fifteen days of registration, inform the Registrar of Firms under the Indian Partnership Act, 1932 about the conversion.
//             <p className='mb-0 pt-2'>1. Provide details of the LLP's registration and any other required information in the prescribed format.
//             </p>
//           </div>
//           <div className={`${active === '7' ? 'active' : 'none'}`}>
//             <h3>Step 7 - Property Registration:</h3>
//             <p className='mb-0 pt-2'>1. Notify relevant authorities of the conversion for any registered properties owned by the firm.
//             <p className='mb-0 pt-2'>1. Comply with the requirements of the respective authorities regarding property transfer.
//             </p>
//           </div>
//           <div className={`${active === '8' ? 'active' : 'none'}`}>
//             <h3>Step 8- Continuation of Legal Proceedings:</h3>
//             <p className='mb-0 pt-2'>1. Ensure that any ongoing legal proceedings involving the firm are continued with the LLP as the successor entity.
//             <p className='mb-0 pt-2'>1. Inform relevant courts, tribunals, or authorities about the conversion for seamless continuation of proceedings.
//             </p>
//           </div>
//           <div className={`${active === '9' ? 'active' : 'none'}`}>
//             <h3>Step 9 - Adaptation of Agreements and Contracts:</h3>
//             <p className='mb-0 pt-2'>1. Update all existing agreements, contracts, and arrangements to reflect the conversion.
//             <p className='mb-0 pt-2'>1. Ensure that rights, obligations, and liabilities are transferred to the LLP without disruption.
//             </p>
//           </div>
//           <div className={`${active === '10' ? 'active' : 'none'}`}>
//             <h3>Step 10 - Partner Liability Management:</h3>
//             <p className='mb-0 pt-2'>1. Inform partners about their continued personal liability for pre-conversion obligations of the firm.
//             <p className='mb-0 pt-2'>1. Establish indemnification arrangements with the LLP to protect partners from such liabilities.
//             </p>
//           </div>
//           <div className={`${active === '11' ? 'active' : 'none'}`}>
//             <h3>Step 11 - Compliance with Notice Requirements:</h3>
//             <p className='mb-0 pt-2'>1. Include conversion details in official correspondence of the LLP for the specified period as mandated by the schedule.
//             <p className='mb-0 pt-2'>1. Ensure timely compliance to avoid penalties for non-compliance.
//             </p>
//           </div>
//           <div className={`${active === '12' ? 'active' : 'none'}`}>
//             <h3>Step 12 - Post-Conversion Compliance:</h3>
//             <p className='mb-0 pt-2'>1. Fulfill any additional regulatory or statutory requirements applicable to LLPs post-conversion.
//             <p className='mb-0 pt-2'>1. Ensure ongoing compliance with LLP regulations and reporting obligations.
//             </p>
//           </div>
//         </div>
