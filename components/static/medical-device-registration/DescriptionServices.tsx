     ...
     <div className='DocumentArrowWise flex w-80 m-auto mobile-flex-column-reverse' id='DescriptionServices'>
      <div className='flex-7'>
        <ul className='tick list-unstyled'>
           <p >Medical Device Registration involves a wide array of products and services, encompassing various healthcare equipment and technologies crucial for diagnosis, treatment, patient care and rehabilitation. These devices vary significantly in complexity, function and intended use.</p>
          ...
          <li><Image alt="ulArrow" className="ulArrow-img" loading="lazy" height={30} width={30} src={ulArrow} /><strong>Medical Software and Applications:</strong> Software or applications integrated with medical devices for data analysis, diagnostics, treatment planning or patient monitoring.</li>
          <p>In the process of Medical Devices Registration, various types of licenses and services are involved, primarily focusing on ensuring the safety, efficacy, and quality of the devices being introduced into the market. Some of the types and distinctions of licenses/services typically associated with medical device registration are:</p>
