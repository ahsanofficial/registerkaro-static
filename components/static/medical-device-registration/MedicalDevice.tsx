    ...
    <div className='DocumentButtonWise w-80 m-auto' id='MedicalDevice'>
      ...
      <div className="flex-4 mt-5">
        ...
        <div className='flex-7'>
          ...
          <p><strong>Clinical Data Requirements:</strong> Depending on the risk classification, some medical devices might require clinical data to establish safety and efficiency. This could involve clinical trials conducted in India or other countries, with the data submitted for review by the CDSCO.</p>
