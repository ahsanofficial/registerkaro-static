    ...
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            <div className='flex-5'>
                <p className='text-justify'>Nowadays, doing business worldwide is so easy because of advanced technology and the internet. However, before starting any business worldwide, you must follow several procedures & laws and get different Registrations and Licenses. <strong>IEC or Import Export Code</strong> is one of such requirements when you are thinking of importing/exporting from India and it is also known as Importer Exporter Code. IEC is a 10-digit unique identification number that is compulsory for import to India or export from India. Unless specifically exempted, any individual shall make no import/export without getting IEC Registration. Hence, IEC Registration Certificate is compulsory for any business involved in the export & import of goods. Therefore, before starting an import of products into India, an importer makes sure that the importing company has GST Registration and IEC Registration Certificates both, of which are required to clear customs.</p>
                        ...
                        <ul>
                            <a href="#ObjectivesChecklist" className="scrollTo">
                             ...
                             <a href="#AdvantagesBIS" className="scrollTo">
                                <li>Benefits of IEC Registration in India</li>
                            </a>
                            <a href="#Eligibility" className="scrollTo">
                                <li>What is the eligibility to get the Import Export Code in India?</li>
                            </a>
                            <a href="#EventBased" className="scrollTo">
                                <li>Prerequisites for applying IEC Code in India</li>
                            </a>
