...
export const DifferentTypes = ({ cityName }: HeroProps) => {
  return (
    <div className='DifferentTypes w-80 m-auto' id='Different'>
      ...
      <div>
        <p><strong>1. Private Limited Company: </strong>This Company is the most prevalent & popular type of corporate legal entity in {cityName}. Private Limited Company is a privately held business entity and Company is privately held by the shareholders & the maximum number of shareholders shouldn’t be more than 200.</p>
