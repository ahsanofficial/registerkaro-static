...
import bft from "../../../assets/images/static/vendor-agreement/What are the Important Clauses in a Vendor Agreement _.svg";

interface HeroProps {
  cityName: string;
}

const WhatImportant = ({ cityName }: HeroProps) => {
  return (
