...
export const RequirementsToFulfil = ({ cityName }: HeroProps) => {
  return (
    <div id='RequirementsToFulfil'>
      <div className="requirementsToFulFil flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
          <p><strong>1. </strong>The applicant must have a legitimate and functioning business or commercial establishment in {cityName}, be an Indian national, or have an abode in {cityName}.</p>
          <p><strong>2. </strong>The applicant needs to have filed for a national trademark application in {cityName} or already have a trademark which is registered with the Indian Trademarks Registry. The international application is based on the national trademark application or registration with the local authority which forwards the application to WIPO.</p>
