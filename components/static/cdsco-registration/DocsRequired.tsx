    ...
    <div id='DocsREquired'>
     ...
     <div className='DocumentArrowWise flex w-80 m-auto mobile-flex-column'>
      <div className='flex-3 ' >
          <Image alt="A description of products/services Involved The CDSCO (Central Drugs Standard Control Organization) in India oversees the registration and regulation of various products and" className="description-img w-100" height={822} loading="lazy" src={dft} />
        </div>
