...
import dft from "../../../assets/images/static/csr-registration/How RegisterKaro Can Assist You in the Franchise Agreement Process_.svg";
    ...
    <div id="WhyChoose">
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-6">
          ...
          <p><strong> Client-oriented approach : </strong>  Our team of experts is well trained and
          equipped with a client-oriented approach, keeping in mind that the
          process must be client-centric, focusing on meeting all the
          requirements of their business and, therefore, satisfying their needs.</p>
          <p>
