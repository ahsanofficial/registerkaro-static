import certificate from '../../../assets/images/static/patent-registration/certificate.svg';
...
export const Process = ({ cityName }: HeroProps) => {
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center">Patent Registration</p>
                <div>
                    <Image alt="what is patent Registration" className="certificate h-100 w-100" loading="lazy" src={certificate} />
                </div>
            </div>
        </div>
    )
