...
const ChallengesInManaging = ({ cityName }: HeroProps) => {
    return (
        <div id="ChallengesInManaging">
            <p className="main-para">Handling compliance for NBFCs in {cityName} can be tough due to several reasons. Here are some main challenges:</p>
            <div className="benefits flex w-80 m-auto mobile-flex-column">
                ...
                <div className="flex-6">
                    <p><strong>1. Complicated Rules :</strong>The rules for NBFCs in {cityName} are complicated and keep changing, which makes it hard for companies to keep track. These rules come from various government bodies like the RBI, SEBI, MCA, IRDA etc.</p>
