        ...
        <div id="PostIncorporation">
            ...
            <div className="benefits flex w-80 m-auto mobile-flex-column">
                ...
                <div className="flex-6">
                    ...
                    <p><strong>5. CERSAI (Central Registry of Securitisation Asset Reconstruction and Security Interest of {cityName}) :</strong>CERSAI functions to preempt fraud in lending, particularly pertaining to equitable mortgages. Its function is to prevent multiple loans against the same asset from different financial institutions. Additionally, it oversees CKYC registration within {cityName}.</p>
