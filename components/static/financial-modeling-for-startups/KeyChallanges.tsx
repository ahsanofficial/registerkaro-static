...
export const KeyChallanges = ({ cityName }: HeroProps) => {
  return (
    <div id="KeyChallanges">
      ...
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        ...
        <div className="flex-4 ">
            <p><strong>1. Market Uncertainty: </strong>{cityName}’s startup ecosystem is dynamic, with changing market trends and regulatory landscapes. Accounting for these uncertainties in the financial model is essential.</p>
