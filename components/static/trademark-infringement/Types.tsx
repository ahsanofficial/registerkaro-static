          ...
          <div className="flex-5">
            ...
            <p><strong>Direct Infringement:</strong> It is further divided into three types:</p>
             <div className="ps-4">
              ...
              <p><strong>3. Use of a similar trademark in the same class</strong>
              
              For constituting direct trademark infringement, the product or service concerned with unauthorized use should also fall under the same class of the registered trademark.</p>
              </div>
