...
export const DocumentsRequired = () => {
  return (
    <div id="DocumentsRequired">
      ...
      <div className="documentsRequired-testing flex w-80 m-auto mobile-flex-column">
      ...
      <div className="documentsRequired-register flex w-80 m-auto mobile-flex-column-reverse">        
        <div className="flex-7">
      ...
      <div className="DocumentsRequired-info flex w-80 m-auto mobile-flex-column">
        <div className="flex-3">
          <Image
            alt="DocumentsRequired of BEE Certification"
            className="documentsRequired-img w-100 Importance-img-h-100"
