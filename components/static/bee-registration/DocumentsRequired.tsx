  ...
  return (
    <div id="DocumentsRequired">
      ...
      <div className="documentsRequired flex w-80 m-auto mobile-flex-column">
        ...
        <p className="pt-5">The following documents are needed for the testing lab:</p>
          ...
          <p className="pt-5">The following documents are needed for businesses to register under BEE:</p>
          ...
          <p className="pt-5">The following technical information is needed for model registration according to BEE:</p>
