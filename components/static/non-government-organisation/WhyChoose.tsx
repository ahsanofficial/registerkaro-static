  ...
  return (
    <div id="WhyChoose">
      <p className="main-para">
        {" "}
        RegisterKaro serves as your ultimate solution for the NGO registration
      ...
      <div className="flex-4">
        ...
        <div className="flex-7">
          <p>
            ...
            NGO registration process. Rest assured; our team ensures your
            requirements are met with utmost efficiency.
          </p>
          <p>
            <strong>Cost-effective: </strong>
            RegisterKaro offers premium-quality registration services for the
            NGO registration process at highly competitive rates, ensuring that
          ...
          <p>
            <strong>Process Alteration: </strong>Recognizing the importance of
            customization, we provide flexibility in process structuring,
            allowing you to modify it according to your specific needs,
            requirements, and vision. Our goal is to achieve optimal results
            while ensuring your satisfaction.
          </p>
          <p>
