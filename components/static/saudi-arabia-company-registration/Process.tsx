import certificate from '../../../assets/images/static/saudi-arabia-company-registration/certificate.svg';
...
export const Process = () => {
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center">Company Registration in  Saudi Arabia</p>
                <div>
                    <Image alt="An Overview of Company Registration in Saudi Arabia" className="certificate h-100 w-100" loading="lazy" src={certificate} />
                </div>
            </div>
        </div>
    )
