    ...
    return (
        <div className='process flex w-80 m-auto mobile-flex-column-reverse'>
            <div className='flex-5'>
                <p className='text-justify'>In India, especially women are more fascinated with gold for many years and gold is always a very safe and secure investment for Indian residents during tough times. Hence, to protect customers from adulteration and to obligate jewelers to maintain the purity of jewellery, the Bureau of Indian Standards launched a jeweller Registration Scheme. BIS introduced the Gold Hallmarking Scheme in 2000 & a Silver Hallmarking Scheme in 2005. It is the accurate determination & official recording of the equivalent content of precious metal (such as gold and silver) in precious metal articles. Thus, Hallmarks are legal marks used in many countries as a guarantee of the purity/fitness of precious metal article. The primary objectives of the Hallmarking Scheme are to safeguard the public against adulteration & to obligate all the manufacturers to maintain legal standards of fitness. If we see in India especially two metals, namely Gold & Silver, have been brought under the purview of Hallmarking. Are you looking for Hallmark Registration in India? Then, you are at the right place. We offer Hallmark Registration at an affordable cost & quick turnaround.</p>
                    ...
                    <ul>
                        <ul>
                            ...
                            <a href="#Procedure" className="scrollTo">
                                <li>Procedure for Hallmark Registration in India</li>
                            </a>
            ...
            <div className='flex-5'>
                <p className="small-heading text-center"> Hallmark Registration Online in India</p>
