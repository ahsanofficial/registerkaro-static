...
import bft from "../../../assets/images/static/remote-chief-financial-officer-services/pre-incorporation.svg";

interface HeroProps {
  cityName: string;
}

const NeedOfMsme = ({ cityName }: HeroProps) => {
  return (
    <div id="NeedOfMsme">
      <div className="benefits flex w-80 m-auto mobile-flex-column">
        <div className="flex-3">
          <Image
            alt="Need of Remote CFO for MSMEs"
