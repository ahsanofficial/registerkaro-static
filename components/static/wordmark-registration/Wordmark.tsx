    ...
    <div id="Wordmark">
      <div className="benefits flex w-80 m-auto mobile-flex-column-reverse">
        <div className="flex-7">
            ...
            <p><strong>Use or Intent to Use: </strong>In India, an applicant can file for a trademark based on actual use of the mark or with an intention to use it. However, proof of use might be required at a later stage for registration.</p>
