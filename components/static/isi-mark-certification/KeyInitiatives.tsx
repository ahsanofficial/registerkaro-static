  ...
  return (
    ...
    <div id='KeyInitiatives'>
     <div className='DocumentArrowWise  w-80 m-auto mobile-flex-column-reverse'>
      ...
      <p className='main-para pt-5'>These documents collectively contribute to the thorough evaluation and verification process required for obtaining ISI Certification.</p>
    </div>
  )
}