...
export const WhyChoose = ({ cityName }: HeroProps) => {
  return (
    <div id="WhyChoose">
      <p className="main-para">RegisterKaro has been a one-stop solution for acquiring  businesses lisences of  various types in  for the varied ranges of benefits such as:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column">
      
        <div className="flex-3">
          <Image
            alt="Why Choose RegisterKaro for payment gateway licence?"
        ...
        <div className="flex-7">
            <p><strong>Pool of Experts :</strong>RegisterKaro holds a large pool of Experts from all over the world specializing in registration services of different types.  Our team of experts makes sure that your work is taken care of in the most effective manner possible.</p>
