    ...
    <div id="Types">
      ...
      <div className="flex-3">
        ...
        <div className="flex-5">
            ...
            <p><strong> Credibility and Trust : </strong>Having compliances and the lisences that are regulated and authorised by the government increases the trust and credibility of the general public on the company.Because to facilitate banking process one needs to submit their bank details and these would be operating on their hard-earned money. In {cityName} during the end of the previous decade the main challenge these payment gateways faced is to get the trust of the Indian customers in the Indian market.</p>
