...
import dft from "../../../assets/images/static/netherlands-company-registration/whychoose_does_RegisterKaro.svg"

export const WhyChoose = () => {
  return (
    <div id="WhyChoose">
      <p className="main-para">RegisterKaro has been one stop solution for Netherlands Company Registration for the varied ranges of benefits such as:</p>
      <div className="benefits flex w-80 m-auto mobile-flex-column">
        ...
        <div className="flex-7 pt-2">
           ...
           <p><strong>Cost-effective :</strong>  RegisterKaro Netherlands Company Registration Related services are of premium quality at the most efficient rate, which suits the client's pocket, making sure that quality service is not the only thing the client gains on our platform.</p>
