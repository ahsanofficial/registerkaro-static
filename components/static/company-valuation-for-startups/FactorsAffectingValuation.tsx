...
export const FactorsAffectingValuation = ({ cityName }: HeroProps) => {
  return (
    <div id='FactorsAffectingValuation'>
      <div className="factors-affecting-valuation flex w-80 m-auto mobile-flex-column-reverse">
        ...
        <div className="flex-7">
          <p><strong>1. Market Potential: </strong>Investors assess the startup’s addressable market size, growth potential, and scalability within the Indian market. {cityName}’s growing population and increasing consumer demand in various sectors like technology, e-commerce, healthcare, and FinTech influence valuation.</p>
          ...
          <p><strong>3. Technology and Innovation: </strong>Innovative technologies, unique business models, patents, or proprietary technologies can significantly impact valuations in {cityName}’s competitive startup landscape.</p>
